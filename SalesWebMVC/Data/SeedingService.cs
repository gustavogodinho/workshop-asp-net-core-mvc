...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller("Bob Brown", "bob@gmail.com", 100.0, new DateTime(1998, 4, 21), d1);
            Seller s2 = new Seller("Adriano Mineiro", "sem@gmail.com", 100.0, new DateTime(1998, 4, 21), d2);
            Seller s3 = new Seller("Luiz Paulo Bacarini", "sem@gmail.com", 100.0, new DateTime(1998, 4, 21), d1);
            Seller s4 = new Seller("Leandro Beni", "sem@gmail.com", 100.0, new DateTime(1998, 4, 21), d1);
            Seller s5 = new Seller("Milena", "micardial@gmail.com", 100.0, new DateTime(1998, 4, 21), d3);
            Seller s6 = new Seller("Paulo Moutinho", "sem@gmail.com", 100.0, new DateTime(1998, 4, 21), d2);
